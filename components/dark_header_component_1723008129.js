...
Vue.component("dark_header_component_1723008129", {
    template: `
    <header id="header-component" style="min-height: 190px" class="z-30 bg-white">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div id="site-branding" class="shrink-0 mr-4 lg:fixed">
                    ...
                    <a class="flex items-center space-x-4" href="index.html" aria-label="Cruip">
                        ...
                        <span id="site-name" :class="siteNameStyle">BlockExplorer</span>
                    </a>
                </div>
                <!-- Right side -->
